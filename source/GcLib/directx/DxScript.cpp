...
void DxScriptObjectManager::AddRenderObject(gstd::ref_count_ptr<DxScriptObjectBase>::unsync obj)
{
	...
	if (tPri > objRender_.size() - 1)
		tPri = objRender_.size() - 1;
...
function const dxFunction[] = {
	...
	{ "MOUSE_LEFT", constant<MOUSE_KEY_LEFT>::func, 0 },
	{ "MOUSE_RIGHT", constant<MOUSE_KEY_RIGHT>::func, 0 },
	{ "MOUSE_MIDDLE", constant<MOUSE_KEY_MIDDLE>::func, 0 },

	// New! From SDL
	{ "MOUSE_X1", constant<MOUSE_KEY_X1>::func, 0 },
	{ "MOUSE_X2", constant<MOUSE_KEY_X2>::func, 0 },

	{ "KEY_ESCAPE", constant<SDLK_ESCAPE>::func, 0 },
	{ "KEY_1", constant<SDLK_1>::func, 0 },
	{ "KEY_2", constant<SDLK_2>::func, 0 },
	{ "KEY_3", constant<SDLK_3>::func, 0 },
	{ "KEY_4", constant<SDLK_4>::func, 0 },
	{ "KEY_5", constant<SDLK_5>::func, 0 },
	{ "KEY_6", constant<SDLK_6>::func, 0 },
	{ "KEY_7", constant<SDLK_7>::func, 0 },
	{ "KEY_8", constant<SDLK_8>::func, 0 },
	{ "KEY_9", constant<SDLK_9>::func, 0 },
	{ "KEY_0", constant<SDLK_0>::func, 0 },
	{ "KEY_MINUS", constant<SDLK_MINUS>::func, 0 },
	{ "KEY_EQUALS", constant<SDLK_EQUALS>::func, 0 },
	{ "KEY_BACK", constant<SDLK_BACKSPACE>::func, 0 },
	{ "KEY_TAB", constant<SDLK_TAB>::func, 0 },
	{ "KEY_Q", constant<SDLK_q>::func, 0 },
	{ "KEY_W", constant<SDLK_w>::func, 0 },
	{ "KEY_E", constant<SDLK_e>::func, 0 },
	{ "KEY_R", constant<SDLK_r>::func, 0 },
	{ "KEY_T", constant<SDLK_t>::func, 0 },
	{ "KEY_Y", constant<SDLK_y>::func, 0 },
	{ "KEY_U", constant<SDLK_u>::func, 0 },
	{ "KEY_I", constant<SDLK_i>::func, 0 },
	{ "KEY_O", constant<SDLK_o>::func, 0 },
	{ "KEY_P", constant<SDLK_p>::func, 0 },
	{ "KEY_LBRACKET", constant<SDLK_LEFTBRACKET>::func, 0 },
	{ "KEY_RBRACKET", constant<SDLK_RIGHTBRACKET>::func, 0 },
	{ "KEY_RETURN", constant<SDLK_RETURN>::func, 0 },
	{ "KEY_LCONTROL", constant<SDLK_LCTRL>::func, 0 },
	{ "KEY_A", constant<SDLK_a>::func, 0 },
	{ "KEY_S", constant<SDLK_s>::func, 0 },
	{ "KEY_D", constant<SDLK_d>::func, 0 },
	{ "KEY_F", constant<SDLK_f>::func, 0 },
	{ "KEY_G", constant<SDLK_g>::func, 0 },
	{ "KEY_H", constant<SDLK_h>::func, 0 },
	{ "KEY_J", constant<SDLK_j>::func, 0 },
	{ "KEY_K", constant<SDLK_k>::func, 0 },
	{ "KEY_L", constant<SDLK_l>::func, 0 },
	{ "KEY_SEMICOLON", constant<SDLK_SEMICOLON>::func, 0 },
	{ "KEY_APOSTROPHE", constant<SDLK_QUOTE>::func, 0 },
	{ "KEY_GRAVE", constant<SDLK_BACKQUOTE>::func, 0 },
	{ "KEY_LSHIFT", constant<SDLK_LSHIFT>::func, 0 },
	{ "KEY_BACKSLASH", constant<SDLK_BACKSLASH>::func, 0 },
	{ "KEY_Z", constant<SDLK_z>::func, 0 },
	{ "KEY_X", constant<SDLK_x>::func, 0 },
	{ "KEY_C", constant<SDLK_c>::func, 0 },
	{ "KEY_V", constant<SDLK_v>::func, 0 },
	{ "KEY_B", constant<SDLK_b>::func, 0 },
	{ "KEY_N", constant<SDLK_n>::func, 0 },
	{ "KEY_M", constant<SDLK_m>::func, 0 },
	{ "KEY_COMMA", constant<SDLK_COMMA>::func, 0 },
	{ "KEY_PERIOD", constant<SDLK_PERIOD>::func, 0 },
	{ "KEY_SLASH", constant<SDLK_SLASH>::func, 0 },
	{ "KEY_RSHIFT", constant<SDLK_RSHIFT>::func, 0 },
	{ "KEY_MULTIPLY", constant<SDLK_KP_MULTIPLY>::func, 0 },
	{ "KEY_LMENU", constant<SDLK_LALT>::func, 0 },
	{ "KEY_SPACE", constant<SDLK_SPACE>::func, 0 },
	{ "KEY_CAPITAL", constant<SDLK_CAPSLOCK>::func, 0 },
	{ "KEY_F1", constant<SDLK_F1>::func, 0 },
	{ "KEY_F2", constant<SDLK_F2>::func, 0 },
	{ "KEY_F3", constant<SDLK_F3>::func, 0 },
	{ "KEY_F4", constant<SDLK_F4>::func, 0 },
	{ "KEY_F5", constant<SDLK_F5>::func, 0 },
	{ "KEY_F6", constant<SDLK_F6>::func, 0 },
	{ "KEY_F7", constant<SDLK_F7>::func, 0 },
	{ "KEY_F8", constant<SDLK_F8>::func, 0 },
	{ "KEY_F9", constant<SDLK_F9>::func, 0 },
	{ "KEY_F10", constant<SDLK_F10>::func, 0 },
	{ "KEY_NUMLOCK", constant<SDLK_NUMLOCKCLEAR>::func, 0 },
	{ "KEY_SCROLL", constant<SDLK_SCROLLLOCK>::func, 0 },
	{ "KEY_NUMPAD7", constant<SDLK_KP_7>::func, 0 },
	{ "KEY_NUMPAD8", constant<SDLK_KP_8>::func, 0 },
	{ "KEY_NUMPAD9", constant<SDLK_KP_9>::func, 0 },
	{ "KEY_SUBTRACT", constant<SDLK_KP_MINUS>::func, 0 },
	{ "KEY_NUMPAD4", constant<SDLK_KP_4>::func, 0 },
	{ "KEY_NUMPAD5", constant<SDLK_KP_5>::func, 0 },
	{ "KEY_NUMPAD6", constant<SDLK_KP_6>::func, 0 },
	{ "KEY_ADD", constant<SDLK_KP_PLUS>::func, 0 },
	{ "KEY_NUMPAD1", constant<SDLK_KP_1>::func, 0 },
	{ "KEY_NUMPAD2", constant<SDLK_KP_2>::func, 0 },
	{ "KEY_NUMPAD3", constant<SDLK_KP_3>::func, 0 },
	{ "KEY_NUMPAD0", constant<SDLK_KP_0>::func, 0 },
	{ "KEY_DECIMAL", constant<SDLK_KP_DECIMAL>::func, 0 },
	{ "KEY_F11", constant<SDLK_F11>::func, 0 },
	{ "KEY_F12", constant<SDLK_F12>::func, 0 },
	{ "KEY_F13", constant<SDLK_F13>::func, 0 },
	{ "KEY_F14", constant<SDLK_F14>::func, 0 },
	{ "KEY_F15", constant<SDLK_F15>::func, 0 },
#if 0 // § TODO
		/* Currently the input does not support usage of SDL2 Scancodes
		* The input would require different form of updates to avoid hardcoding SCANCODE_* keys
		*  as well as handling them correctly.
		* Altrought I hardly doubt anyone would ever need to use JP-specific keys.
		*/
	{ "KEY_KANA", constant<SDL_SCANCODE_LANG3 + SCANCODE_OFFSET>::func, 0 }, // PC-98 106/PC-98/J-3100 (Katakana)
	{ "KEY_CONVERT", constant<SDLK_CONVERT>::func, 0 }, // PC-98 106/AX
	{ "KEY_NOCONVERT", constant<SDLK_NOCONVERT>::func, 0 }, // PC-98 106/PC-98/AX
	{ "KEY_YEN", constant<SDLK_YEN>::func, 0 }, // PC-98 106/PC-98/AX/J-3100
	{ "KEY_CIRCUMFLEX", constant<SDLK_CIRCUMFLEX>::func, 0 }, // PC-98 106/PC-98
	{ "KEY_AT", constant<SDLK_AT>::func, 0 }, // PC-98 106/PC-98
	{ "KEY_COLON", constant<SDLK_COLON>::func, 0 }, // PC-98 106/PC-98
	{ "KEY_UNDERLINE", constant<SDLK_UNDERLINE>::func, 0 }, // PC-98
	{ "KEY_KANJI", constant<SDLK_KANJI>::func, 0 }, // PC-98 106/PC-98/AX/J-3100
	{ "KEY_AX", constant<SDLK_AX>::func, 0 }, // AX
	{ "KEY_UNLABELED", constant<SDLK_UNLABELED>::func, 0 }, // J-3100
#endif
	{ "KEY_NUMPADEQUALS", constant<SDLK_KP_EQUALS>::func, 0 },
	{ "KEY_STOP", constant<SDLK_STOP>::func, 0 },
	{ "KEY_NUMPADENTER", constant<SDLK_KP_ENTER>::func, 0 },
	{ "KEY_RCONTROL", constant<SDLK_RCTRL>::func, 0 },
	{ "KEY_NUMPADCOMMA", constant<SDLK_KP_PERIOD>::func, 0 },
	{ "KEY_DIVIDE", constant<SDLK_KP_DIVIDE>::func, 0 },
	{ "KEY_SYSRQ", constant<SDLK_SYSREQ>::func, 0 },
	{ "KEY_RMENU", constant<SDLK_RALT>::func, 0 },
	{ "KEY_PAUSE", constant<SDLK_PAUSE>::func, 0 },
	{ "KEY_HOME", constant<SDLK_HOME>::func, 0 },
	{ "KEY_UP", constant<SDLK_UP>::func, 0 },
	{ "KEY_PRIOR", constant<SDLK_PRIOR>::func, 0 },
	{ "KEY_LEFT", constant<SDLK_LEFT>::func, 0 },
	{ "KEY_RIGHT", constant<SDLK_RIGHT>::func, 0 },
	{ "KEY_END", constant<SDLK_END>::func, 0 },
	{ "KEY_DOWN", constant<SDLK_DOWN>::func, 0 },
	{ "KEY_NEXT", constant<SDLK_PAGEDOWN>::func, 0 },
	{ "KEY_INSERT", constant<SDLK_INSERT>::func, 0 },
	{ "KEY_DELETE", constant<SDLK_DELETE>::func, 0 },
	{ "KEY_LWIN", constant<SDLK_LGUI>::func, 0 },
	{ "KEY_RWIN", constant<SDLK_RGUI>::func, 0 },
	{ "KEY_APPS", constant<SDLK_APPLICATION>::func, 0 },
	{ "KEY_POWER", constant<SDLK_POWER>::func, 0 },
	{ "KEY_SLEEP", constant<SDLK_SLEEP>::func, 0 },
