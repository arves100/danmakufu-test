...
4. Go to .build/projects/gmake-linux and build bgfx two times `make config=debug32` (or `config=debug64`) and `make config=release32` (or `config=release64`), make sure to at least build the following projects:
- shaderc
- bgfx
- bimg
- bx
